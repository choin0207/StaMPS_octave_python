...
%Np = 5; % order
% Octave/GNU-compatible replacement for MATLAB fdesign.rsrc (Signal Processing Toolbox)
% Uses Octave signal package: resample() with Kaiser window
% pkg load signal  % uncomment if signal package not auto-loaded
hfrac = [];  % placeholder; actual resampling done via resample() below
% Note: hfrac is passed to upfirdn in original; replaced by resample() at usage site
